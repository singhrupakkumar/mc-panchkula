 ...
 <script src="<?php echo e(asset('backend/js/dropify.js')); ?>"></script>
 ...
 <script src="<?php echo e(asset('backend/js/admin-datatables-delete-action-items.js')); ?>"></script>
 <!-- Custom Js -->
 <script src="<?php echo e(asset('backend/js/common.js')); ?>"></script>

<?php /**PATH /var/www/html/nursery/resources/views/admin/partials/scripts.blade.php ENDPATH**/ ?>